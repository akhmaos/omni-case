...
/*
HealthCheckInternalServerError pkg server error
...
func (o *HealthCheckInternalServerError) WithPayload(payload models.InternalServerError) *HealthCheckInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the health check internal server error response
func (o *HealthCheckInternalServerError) SetPayload(payload models.InternalServerError) {
	o.Payload = payload
}
