...
type HealthCheckHandlerFunc func(HealthCheckParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn HealthCheckHandlerFunc) Handle(params HealthCheckParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// HealthCheckHandler interface for that can handle valid health check params
type HealthCheckHandler interface {
	Handle(HealthCheckParams, interface{}) middleware.Responder
}
